package com.example.myboard.comment.entity;
...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = 1933139048L;
    ...
    public final com.example.myboard.post.entity.QPost post;
    ...
    public QComment(Class<? extends Comment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.post = inits.isInitialized("post") ? new com.example.myboard.post.entity.QPost(forProperty("post"), inits.get("post")) : null;
